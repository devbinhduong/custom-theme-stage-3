...
export default class ProductDetails extends ProductDetailsBase {
    constructor($scope, context, productAttributesData = {}) {
        ...
        $productOptionsElement.on('change', event => {
            ...
            /* Check Variant Type Email */
            this.checkEmailProductOptions();
        });
    ...
    /* Check Email Product Options */
    checkEmailProductOptions() {
        let inputEmail = document.querySelectorAll("[data-product-option-change] .form-field .form-input"),
            buyButton = document.querySelector("#form-action-addToCart");

        const errorText = document.querySelector('.check-email-error-text');

        buyButton.parentNode.insertBefore(errorText, buyButton);

        const email = inputEmail[1].value;
